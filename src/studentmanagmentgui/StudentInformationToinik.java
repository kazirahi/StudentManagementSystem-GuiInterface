...
public class StudentInformationToinik extends JFrame {

	private JPanel contentPane;

	
	public StudentInformationToinik() {
		...
		label_2.setIcon(new ImageIcon(StudentInformationToinik.class.getResource("/image/toinik.png")));
		label_2.setHorizontalAlignment(SwingConstants.CENTER);
		label_2.setBounds(20, 108, 114, 122);
		contentPane.add(label_2);
		
		JLabel lblFariaFerdowsyPriteemony = new JLabel("Tammim Yeasmin");
		...
		JLabel lblFathers = new JLabel("Father's Name: Md. Eliash khan");
		...
		JLabel lblMothersNameKazi = new JLabel("Mother,s Name: Mrs. Afroza khanom");
		...
		JLabel lblDateOfBirth = new JLabel("Date of Birth: 17th October, 1997");
		...
		JLabel lblEmailPriteemonyagmailcom_1 = new JLabel("Email: tammimtoinik4@gmail.com");
		...
		JLabel lblBloodGroupA = new JLabel("Blood Group: A(+)");
