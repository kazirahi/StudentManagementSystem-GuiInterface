...
public class StudentInformationTasmi extends JFrame {

	private JPanel contentPane;

	
	public StudentInformationTasmi() {
		...
		label_2.setIcon(new ImageIcon(StudentInformationTasmi.class.getResource("/image/tasmi.png")));
		label_2.setHorizontalAlignment(SwingConstants.CENTER);
		label_2.setBounds(20, 108, 114, 122);
		contentPane.add(label_2);
		
		JLabel lblFariaFerdowsyPriteemony = new JLabel("Kaniz Fatema");
		...
		JLabel lblFathers = new JLabel("Father's Name: Md. Abul kashem");
		...
		JLabel lblMothersNameKazi = new JLabel("Mother,s Name: Selena Akhter");
		...
		JLabel lblDateOfBirth = new JLabel("Date of Birth: 26 August, 1997");
		...
		JLabel lblEmailPriteemonyagmailcom_1 = new JLabel("Email: tasmitasmi487@gmail.com");
